from sklearn.linear_model import LinearRegression, LogisticRegression, ElasticNet, HuberRegressor, Lasso, Ridge, BayesianRidge, OrthogonalMatchingPursuit, Perceptron, PassiveAggressiveClassifier, SGDClassifier, SGDRegressor, RidgeClassifier
...
QUICK_CLASSIFICATION_MODELS = [
    ...
    {
        "name": SGD_CLASSIFIER.__class__.__name__,
